                ...
                <div class="login_inner">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <form action="<?=$host?>/front/process_register" method="POST" id="regis" class="login_form row">
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="text" name="nama_lengkap" data-validation="required custom" data-validation-regexp="^([a-zA-Z\s]+)$" placeholder="Nama Lengkap">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="email" name="email" data-validation="required email" placeholder="Email">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="password" data-validation="required alphanumeric length" data-validation-length="6-25" name="password" placeholder="Password">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="text" name="no_telepon" data-validation="required custom" data-validation-regexp="^([0-9\s\-\+]+)$" placeholder="No. Telepon">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="password" nama="re_password" data-validation="confirmation" placeholder="Password Konfirmasi">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <button type="submit" value="submit" class="btn subs_btn form-control">register now</button>
                                </div>
                                <div class="col-lg-6 form-group">
                                    Have an account ? <a href="<?=$host."/login"?>">Login Here</a>
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-2"></div>
