...
<head>
  ...
  <title>Green Bakery | Login</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=$host;?>/assets/back/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Green</b>Bakery</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masukkan Informasi Akun Anda</p>

    <form action="<?=$host;?>/panel/do_login" method="post">
...
<!-- iCheck -->
<script src="<?=$host;?>/assets/back/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
