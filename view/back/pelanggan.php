    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="txtTitleModalPelanggan">Master Tambah Pelanggan</h4>
        </div>
		<form role="form" id="idFormModalPelanggan" method="post" action="<?=$host;?>/panel/tambah_pelanggan" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="box-body">
					<div class="form-group">
						<label>Nama Lengkap</label>
						<input type="hidden" name="id_pelanggan" id="idTxtPelanggan">
						<input type="text" name="nama_lengkap" class="form-control" id="idTxtNamaPelanggan" placeholder="Ketikan Nama Lengkap">
					</div>
					<div class="form-group">
						<label>Email</label>
						<input type="text" name="email" class="form-control" id="idTxtEmail" placeholder="Masukkan Username">
					</div>
					<div class="form-group">
						<label>No. Telp</label>
						<input type="text" name="no_telepon" class="form-control" id="idTxtNoTelp" placeholder="Masukkan Password">
					</div>
				</div>
				<!-- /.box-body -->
			</div>
...
<script>
  ...
  $('.edit').click(function(){
    var id = this.id;
    $('#modal-default').modal();
    $("#txtTitleModalPelanggan").html("Ubah Pelanggan");
    $("#idFormModalPelanggan").attr("action", "<?=$host;?>/panel/ubah_pelanggan");
    $.post("<?=$host;?>/panel/ambil_data_pengguna",{id_pelanggan:id}).done(function(data){
      var data = jQuery.parseJSON(data);
      // console.log(data);
      $("#idTxtPelanggan").val(data[0]);
      $("#idTxtNamaPengguna").val(data[2]);
      $("#idTxtEmail").val(data[3]);
	  $("#idTxtNoTelp").val(data[3]);
    })
  })

  $('.tambah').click(function(){
      $("#idFormModalPelanggan").attr("action", "<?=$host;?>/panel/tambah_pelanggan");
      $("#txtTitleModalPelanggan").html("Tambah Pelanggan");
  })
</script>
